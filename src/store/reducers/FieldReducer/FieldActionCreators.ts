...
export const clickContextCell = (x: number, y: number, maskValue: Mask) => (dispatch: AppDispatch) => {
    switch (maskValue) {
...
export const clickCell = (x: number, y: number, maskValue: Mask, value: cellValue) => (dispatch: AppDispatch) => {
